        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalInformationId = table.Column<int>(type: "int", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_HospitalInformation_HospitalInformationId",
                        column: x => x.HospitalInformationId,
                        principalTable: "HospitalInformation",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_HospitalInformation_HospitalInformationId",
                        column: x => x.HospitalInformationId,
                        principalTable: "HospitalInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionCharge = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NoOfDays = table.Column<int>(type: "int", nullable: false),
                    NursingCharge = table.Column<int>(type: "int", nullable: false),
                    LabCharge = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrescribedMedicines_Medicine_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalReports_Medicine_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicine",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalReports_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_HospitalInformationId",
                table: "Contacts",
                column: "HospitalInformationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalReports_MedicineId",
                table: "MedicalReports",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalReports_SupplierId",
                table: "MedicalReports",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_HospitalInformationId",
                table: "Rooms",
                column: "HospitalInformationId");
